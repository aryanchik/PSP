...
const getAllStocks = (req, res) => {
    ...
    const stocks = stocksService.findAll(title); // <--- Проверь эту строку!
    res.json(stocks);
};
...
const getAnalysisStocks = (req, res) => {
    const hardcodedWord = 'Анализ';

    const stocks = stocksService.findAll(hardcodedWord);
